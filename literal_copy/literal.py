...
class Literal:
    def __init__(self, string: str, type: str) -> None:
        ...
        use this string, e.g. paste it to clipboard, print to `stdout` or save to disk. You will not need to initialise `Literal` yourself.
    ...
    def save(self, path: str, overwrite: bool = False) -> None:
        ...
        :type path: str
        :param overwrite: If a file in `path`, exists, it will only be overwritten if `overwrite=True`, defaults to False
